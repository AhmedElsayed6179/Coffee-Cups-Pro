// ========================== dashboard.js ==========================
// Handles all UI interactions, login state, and preloader for admin dashboard
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    async function updateUIBasedOnLogin() {
        ...
        // Profile buttons
        const profileBtns = [document.getElementById("navProfileBtn"), document.getElementById("footerProfileBtn")];
